    ...
    <div className="w-screen">
      ...
      <div className="  flex flex-col items-center justify-center min-h-screen">
        ...
        <div className="w-[312px] h-[138px] gap-2 bg-[#F6F6F6] flex flex-col items-center justify-center">
          ...
          <h6 className="font-poppins font-bold text-[#6c7275] text-[16px]">
            ADDRESS
          </h6>
          <p className="font-poppins text-center font-semibold  text-[#141718] text-[16px]">
            314 Lekki Phase 1. Lagos, Nigeria
          </p>
        </div>
        <div className="w-[312px] h-[138px] gap-2 bg-[#F6F6F6] flex flex-col items-center justify-center">
          <div className="bg-[#BC2B2A] rounded-full w-[30px] h-[30px] flex  text-center justify-center items-center">
        ...
        <div className="flex space-x-2 ml-8 mt-5 ">
          ...
          <div className="flex flex-col">
            <h4 className="font-bold font-catamaran text-[18px] text-[#0E2744] ml-8">
              Write To Us
            </h4>
            <p className="mr-3 text-[14px] font-poppins text-[#00000]">
          ...
          <div className="mt-2 flex flex-col  w-[311px] gap-2">
            <form className="space-y-4 " onSubmit={handleSubmit}>
              ...
              <div>
                <label className="font-poppins font-bold text-[#6c7275] text-[12px]">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-[311px] h-[140px] bg-[#F0F0F0] items-center p-2 text-gray-700  focus:outline-none"
                  ></textarea>
                  {errors.message && (
              ...
              <div className="flex items-center">
                <button
                  type="submit"
                  className="bg-[#BC2B2A] text-white  p-2 rounded w-[194px]  mb-6"
                >
                  Send Message
                </button>
              </div>
